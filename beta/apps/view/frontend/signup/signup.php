<div class="row">
  <div class="large-12 columns" style="padding-top:0em;">
    <h3>Pendaftaran</h3>
    <hr>
  </div>
	...
	<div class="large-12 columns">
		...
		<div data-alert class="alert-box warning radius">
			Pendaftaran gagal, silakan coba email yang lain.
			<a href="#" class="close">&times;</a>
		</div>
		<?php endif; ?>
	</div>
      ...
      <?php endif; ?>
        ...
        <div class="row">
          <div class="large-12 columns">
            ...
            <select name="s_kelas" id="s_kelas" placeholder="Pilih Kelas" required>

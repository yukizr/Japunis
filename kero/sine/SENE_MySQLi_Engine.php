...
class SENE_MySQLi_Engine{
  ...
  public function begin($utype=""){
  	$utype = strtolower($utype);
  	if($utype == 'read_only'){
		return  $this->__mysqli->begin_transaction(MYSQLI_TRANS_START_READ_ONLY);
	}else if($utype=="read_write"){
		return  $this->__mysqli->begin_transaction(MYSQLI_TRANS_START_READ_WRITE);
	}else{
  ...
  public function rollback(){
	...
	*/
	...
	public function setCharSet($cs){
		return $this->__mysqli->set_charset($cs);
	}
}

    ...
    <div class="large-12 columns">
		...
		<div class="row">
				...
				<form method="POST"  action="<?php echo base_url().$spage.""; ?>">
					...
					<div class="row collapse postfix-round">
						<div class="small-3 columns">
							<input style="height:3.3125rem;" type="submit" value="Search" class="button postfix"></input>
						</div>

						<div class="small-9 columns">
							<input  style="text-align:right;height:3.3125rem;" type="text" placeholder="Cari Mapel/Judul" name="keyword" value="<?php
			...
			<div class="small-12 medium-12 large-2 columns right">
				...
				<a id="aadd" href="<?php echo base_url("admin/pelajaran/create/"); ?>" class="button expand">Add New</a>
				<?php }else{} ?>
			</div>

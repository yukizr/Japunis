	...
	foreach($sess->admin->menus->left as $key=>$v){
		...
		if(count($v->childs)>0){
			foreach($v->childs as $f){
				if($this->module==$f->identifier){
					$parent[$f->identifier] = 1;
				}else{
					//$parent[$v->identifier] = 0;
				}
			}
	...
	<div id="sidebar-scroll">
		...
		<div class="sidebar-content">
			...
			<a href="<?php echo base_url_admin(); ?>" class="sidebar-brand">
				<img src="<?php echo $this->skins->admin; ?>img/jangiman-login.png" style="width: 90%;" />
			</a>
			<!-- END Brand -->
			...
			<div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
				<div class="sidebar-user-avatar">
					<a href="page_ready_user_profile.html">
						<img src="<?php echo $this->skins->admin; ?>img/placeholders/avatars/avatar2.jpg" alt="avatar" />
					</a>
				</div>

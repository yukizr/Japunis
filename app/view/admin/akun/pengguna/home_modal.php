				...
				<form id="ftambah" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="iusername" type="text" name="username" class="form-control" minlength="4" placeholder="username" required />
							</div>
						</div>
						<div class="form-group">
				...
				<form id="fedit" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					...
					<fieldset>
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="ieusername" type="text" name="username" class="form-control" minlength="4" placeholder="username" required />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input id="ienama" type="text" name="nama" class="form-control" minlength="4" placeholder="Email" />
							</div>
						</div>
					</fieldset>
					<div class="form-group form-actions">

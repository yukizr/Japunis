		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="ftambah" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<input id="iutype" type="hidden" name="utype" value="siswa" />
					<fieldset>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="ifnama">Nama</label>
							<div class="col-md-8">
								<input id="ifnama" type="text" name="fnama" class="form-control" minlength="4" placeholder="Nama" />
							</div>
						</div>
						<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="fedit" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					...
					<input id="ieutype" type="hidden" name="utype" value="siswa" />
					<fieldset>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-md-4 control-label" for="iefnama">Nama</label>
							<div class="col-md-8">
								<input id="iefnama" type="text" name="fnama" class="form-control" minlength="4" placeholder="Nama" />
							</div>
						</div>
						<div class="form-group">
